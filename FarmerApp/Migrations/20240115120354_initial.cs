    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTreatment", x => new { x.ProductsId, x.TreatmentsId });
                    table.ForeignKey(
                        name: "FK_ProductTreatment_Products_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductTreatment_Treatments_TreatmentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTreatment_TreatmentsId",
                table: "ProductTreatment",
                column: "TreatmentsId");
            ...
            migrationBuilder.Sql("INSERT INTO [Users] ([Name], [Email], [Password]) " +
                "VALUES ('Admin', 'admin@gmail.com', 'AQAAAAEAACcQAAAAEFDX4fbgomFmqrXTb6QoZtZkNOCVJ1fBTaPJBWNkOWkHWEh/vpAS9U5Kok9/WnCDuw==')");
        }
